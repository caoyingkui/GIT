...
!function (t, e) {
    ...
    return function (t) {
        ...
        var r = n(16), i = "object" == typeof self && self && self.Object === Object && self,
        ...
        var r = n(15), i = n(47), o = n(48), s = "[object Null]", a = "[object Undefined]",
            f = r ? r.toStringTag : void 0;
        t.exports = function (t) {
            return null == t ? void 0 === t ? a : s : f && f in Object(t) ? i(t) : o(t)
        }
    }, function (t, e, n) {
        var r = n(35), i = n(36), o = n(37), s = n(38), a = n(39);
        ...
        f.prototype.clear = r, f.prototype.delete = i, f.prototype.get = o, f.prototype.has = s, f.prototype.set = a, t.exports = f
    }, function (t, e, n) {
        var r = n(6);
        ...
        var r = n(3), i = n(0), o = "[object AsyncFunction]", s = "[object Function]", a = "[object GeneratorFunction]",
            f = "[object Proxy]";
        t.exports = function (t) {
            if (!i(t)) return !1;
            var e = r(t);
        ...
        var r = n(77), i = n(2), o = Object.prototype, s = o.hasOwnProperty, a = o.propertyIsEnumerable,
            f = r(function () {
                return arguments
            }()) ? r : function (t) {
        ...
        (function (t) {
            var r = n(1), i = n(79), o = "object" == typeof e && e && !e.nodeType && e,
                s = o && "object" == typeof t && t && !t.nodeType && t, a = s && s.exports === o ? r.Buffer : void 0,
                f = (a ? a.isBuffer : void 0) || i;
            t.exports = f
        }).call(e, n(12)(t))
    }, function (t, e, n) {
        var r = n(81), i = n(82), o = n(83), s = o && o.isTypedArray, a = s ? i(s) : r;
        t.exports = a
    }, function (t, e, n) {
        var r = n(87), i = n(89), o = n(13);
        t.exports = function (t) {
        ...
        var r = n(0), i = n(100), o = n(101), s = "Expected a function", a = Math.max, f = Math.min;
        t.exports = function (t, e, n) {
            var c, l, h, u, g, p, d = 0, v = !1, _ = !1, b = !0;
            ...
            function E() {
                ...
                if (c = arguments, l = this, p = n, r) {
                    if (void 0 === g) return d = t = p, g = setTimeout(x, e), v ? y(t) : u;
                    if (_) return g = setTimeout(x, e), y(p)
                }
            ...
            return e = o(e) || 0, r(n) && (v = !!n.leading, h = (_ = "maxWait" in n) ? a(o(n.maxWait) || 0, e) : h, b = "trailing" in n ? !!n.trailing : b), E.cancel = function () {
                void 0 !== g && clearTimeout(g), d = 0, c = p = l = g = void 0
            }, E.flush = function () {
        ...
        var r = u(n(31)), i = u(n(32)), o = u(n(29)), s = u(n(103)), a = u(n(104)), f = u(n(105)), c = u(n(106)),
            l = u(n(107)), h = u(n(108));
        ...
        var g = (r.default.acequire || r.default.require)("ace/range").Range, p = {
            DIFF_EQUAL: 0,
            DIFF_DELETE: -1,
            DIFF_INSERT: 1,
            EDITOR_RIGHT: "right",
        ...
        function d(t) {
            ...
            (this.options = (0, i.default)({
                ...
                showConnectors: !0,
                maxDiffs: 5e3,
                left: {id: null, content: null, mode: null, theme: null, editable: !0, copyLinkEnabled: !0},
                right: {id: null, content: null, mode: null, theme: null, editable: !0, copyLinkEnabled: !0},
                classes: {
                ...
                left: {
                    ...
                    markers: [],
                    lineLengths: []
                }, right: {ace: r.default.edit(this.options.right.id), markers: [], lineLengths: []}, editorHeight: null
                ...
                var t;
                n.lineHeight = n.editors.left.ace.renderer.lineHeight, function (t) {
                    t.editors.left.ace.getSession().on("changeScrollTop", (0, s.default)(function (e) {
                        L(t, "left", e)
                    }, 16)), t.editors.right.ace.getSession().on("changeScrollTop", (0, s.default)(function (e) {
                        L(t, "right", e)
                    }, 16));
                    var e = t.diff.bind(t);
                    t.editors.left.ace.on("change", e), t.editors.right.ace.on("change", e), t.options.left.copyLinkEnabled && h.default.on("#" + t.options.classes.gutterID, "click", "." + t.options.classes.newCodeConnectorLink, function (e) {
                        y(t, e, p.LTR)
                    });
                    ...
                    window.addEventListener("resize", n), b = function () {
                        window.removeEventListener("resize", n)
                    }
                }(n), (t = n).copyRightContainer = document.createElement("div"), t.copyRightContainer.setAttribute("class", t.options.classes.copyRightContainer), t.copyLeftContainer = document.createElement("div"), t.copyLeftContainer.setAttribute("class", t.options.classes.copyLeftContainer), document.getElementById(t.options.classes.gutterID).appendChild(t.copyRightContainer), document.getElementById(t.options.classes.gutterID).appendChild(t.copyLeftContainer), O(n), n.diff()
        ...
        d.prototype = {
            setOptions: function (t) {
                (0, i.default)(this.options, t), this.diff()
            }, getNumDiffs: function () {
                return this.diffs.length
            }, getEditors: function () {
                return {left: this.editors.left.ace, right: this.editors.right.ace}
            }, diff: function () {
                var t = new a.default, e = this.editors.left.ace.getSession().getValue(),
                    n = this.editors.right.ace.getSession().getValue(), r = t.diff_main(n, e);
                t.diff_cleanupSemantic(r), this.editors.left.lineLengths = m(this.editors.left), this.editors.right.lineLengths = m(this.editors.right);
                ...
                r.forEach(function (t, e, n) {
                    ...
                    e.forEach(function (t, e) {
                        if (0 !== e) {
                            for (var i = !1, o = 0; o < n.length; o++) if (r(Math.abs(t.leftStartLine - n[o].leftEndLine)) && r(Math.abs(t.rightStartLine - n[o].rightEndLine))) {
                                n[o].leftStartLine = Math.min(t.leftStartLine, n[o].leftStartLine), n[o].rightStartLine = Math.min(t.rightStartLine, n[o].rightStartLine), n[o].leftEndLine = Math.max(t.leftEndLine, n[o].leftEndLine), n[o].rightEndLine = Math.max(t.rightEndLine, n[o].rightEndLine), i = !0;
                                break
                            }
                            i || n.push(t)
                        } else n.push(t)
                ...
                }(this, i), this.diffs.length > this.options.maxDiffs || (E(this), D(this))
            }, destroy: function () {
                var t = this.editors.left.ace.getValue();
                this.editors.left.ace.destroy();
                var e = this.editors.left.ace.container, n = e.cloneNode(!1);
                n.textContent = t, e.parentNode.replaceChild(n, e);
                var r = this.editors.right.ace.getValue();
                this.editors.right.ace.destroy(), (n = (e = this.editors.right.ace.container).cloneNode(!1)).textContent = r, e.parentNode.replaceChild(n, e), document.getElementById(this.options.classes.gutterID).innerHTML = "", b()
            }
        };
        var b = function () {
        };
        ...
        function y(t, e, n) {
            var r = parseInt(e.target.getAttribute("data-diff-index"), 10), i = t.diffs[r], o = void 0, s = void 0,
                a = void 0, f = void 0, c = void 0, l = void 0;
            ...
            for (var h = "", u = a; u < f; u += 1) h += j(o, u) + "\n";
            var d = s.ace.getSession().getScrollTop();
            s.ace.getSession().replace(new g(c, 0, l, 0), h), s.ace.getSession().setScrollTop(parseInt(d, 10)), t.diff()
        }
        ...
        function x(t, e, n, r, i) {
            ...
            r--, e.markers.push(e.ace.session.addMarker(new g(n, 0, r, 1), o, "fullLine"))
        }

        function L(t, e, n) {
            var r, i, o;
            E(t), D(t), i = (r = t).editors.left.ace.getSession().getScrollTop(), o = r.editors.right.ace.getSession().getScrollTop(), r.copyRightContainer.style.cssText = "top: " + -i + "px", r.copyLeftContainer.style.cssText = "top: " + -o + "px"
        }

        function E(t) {
            t.editors.left.markers.forEach(function (t) {
                this.editors.left.ace.getSession().removeMarker(t)
            }, t), t.editors.right.markers.forEach(function (t) {
        ...
        function S(t, e, n, r, i) {
            var o = {}, s = /^\n/.test(i);
            if (e === p.DIFF_INSERT) {
                var a = w(t.editors.left, n, i), f = C(t.editors.right, r), c = M(t.editors.right, f),
                    l = M(t.editors.left, a.startLine), h = f;
                0 === M(t.editors.left, a.startLine) && s && (s = !1), 0 === a.startChar && I(t.editors.right, r, s) && (h = f + 1);
                var u = a.startLine === a.endLine, g = 0;
                (a.startChar > 0 || u && i.length < l) && c > 0 && a.startChar < l && g++, o = {
                ...
                a = w(t.editors.right, r, i), f = C(t.editors.left, n), c = M(t.editors.left, f);
                var d = M(t.editors.right, a.startLine), v = f;
                0 === M(t.editors.right, a.startLine) && s && (s = !1), 0 === a.startChar && I(t.editors.left, n, s) && (v = f + 1);
                u = a.startLine === a.endLine, g = 0;
                (a.startChar > 0 || u && i.length < d) && c > 0 && a.startChar < d && g++, o = {
                    leftStartLine: v,
                    leftEndLine: v + g,
        ...
        function w(t, e, n) {
            var r = {startLine: 0, startChar: 0, endLine: 0, endChar: 0}, i = e + n.length, o = 0, s = !1, a = !1;
            t.lineLengths.forEach(function (t, n) {
                o += t, !s && e < o && (r.startLine = n, r.startChar = e - o + t, s = !0), !a && i <= o && (r.endLine = n, r.endChar = i - o + t, a = !0)
            }), r.startChar > 0 && M(t, r.startLine) === r.startChar && (r.startLine++, r.startChar = 0), 0 === r.endChar && r.endLine--;
            var f = /\n$/.test(n);
        ...
        function C(t, e) {
            for (var n = t.ace.getSession().doc.getAllLines(), r = 0, i = 0, o = 0; o < n.length; o++) if (e <= (i += n[o].length + 1)) {
                r = o;
                break
            }
            return r
        ...
        function O(t) {
            ...
            var e = A(t, p.EDITOR_LEFT), n = A(t, p.EDITOR_RIGHT), r = Math.max(e, n, t.gutterHeight);
            t.gutterSVG = document.createElementNS(p.SVG_NS, "svg"), t.gutterSVG.setAttribute("width", t.gutterWidth), t.gutterSVG.setAttribute("height", r), document.getElementById(t.options.classes.gutterID).appendChild(t.gutterSVG)
        }
        ...
        function D(t) {
            var e, n;
            e = t, document.getElementById(e.options.classes.gutterID).removeChild(e.gutterSVG), O(e), (n = t).copyLeftContainer.innerHTML = "", n.copyRightContainer.innerHTML = "", t.diffs.forEach(function (t, e) {
                this.options.showDiffs && (x(this, p.EDITOR_LEFT, t.leftStartLine, t.leftEndLine, this.options.classes.diff), x(this, p.EDITOR_RIGHT, t.rightStartLine, t.rightEndLine, this.options.classes.diff), this.options.showConnectors && function (t, e, n, r, i) {
                    ...
                    var a = e * t.lineHeight - o + .5, f = t.gutterWidth + 1, l = r * t.lineHeight - s + .5,
                        h = n * t.lineHeight - o + t.connectorYOffset + .5, u = t.gutterWidth + 1,
                    ...
                    v.setAttribute("d", d), v.setAttribute("class", t.options.classes.connector), t.gutterSVG.appendChild(v)
        ...
        var r = n(33), i = n(91)(function (t, e, n) {
            r(t, e, n)
        });
        t.exports = i
    }, function (t, e, n) {
        var r = n(34), i = n(17), o = n(66), s = n(68), a = n(0), f = n(26);
        t.exports = function t(e, n, c, l, h) {
            e !== n && o(n, function (o, f) {
                if (a(o)) h || (h = new r), s(e, n, f, c, t, l, h); else {
                    var u = l ? l(e[f], o, f + "", e, n, h) : void 0;
                    void 0 === u && (u = o), i(e, f, u)
                }
            }, f)
        }
    }, function (t, e, n) {
        var r = n(4), i = n(40), o = n(41), s = n(42), a = n(43), f = n(44);
        ...
        c.prototype.clear = i, c.prototype.delete = o, c.prototype.get = s, c.prototype.has = a, c.prototype.set = f, t.exports = c
    }, function (t, e) {
        t.exports = function () {
            this.__data__ = [], this.size = 0
        }
    }, function (t, e, n) {
        var r = n(5), i = Array.prototype.splice;
        t.exports = function (t) {
        ...
        var r = n(10), i = n(49), o = n(0), s = n(51), a = /^\[object .+?Constructor\]$/, f = Function.prototype,
            c = Object.prototype, l = f.toString, h = c.hasOwnProperty,
        ...
        var r = n(15), i = Object.prototype, o = i.hasOwnProperty, s = i.toString, a = r ? r.toStringTag : void 0;
        t.exports = function (t) {
        ...
        var r, i = n(50), o = (r = /[^.]+$/.exec(i && i.keys && i.keys.IE_PROTO || "")) ? "Symbol(src)_1." + r : "";
        t.exports = function (t) {
            return !!o && o in t
        }
    }, function (t, e, n) {
        ...
        var r = n(54), i = n(61), o = n(63), s = n(64), a = n(65);
        ...
        var r = n(55), i = n(4), o = n(14);
        t.exports = function () {
            this.size = 0, this.__data__ = {hash: new r, map: new (o || i), string: new r}
        }
    }, function (t, e, n) {
        var r = n(56), i = n(57), o = n(58), s = n(59), a = n(60);
        ...
        var r = n(7), i = "__lodash_hash_undefined__", o = Object.prototype.hasOwnProperty;
        t.exports = function (t) {
            var e = this.__data__;
            if (r) {
                var n = e[t];
        ...
        var r = n(7), i = Object.prototype.hasOwnProperty;
        t.exports = function (t) {
            var e = this.__data__;
        ...
        var r = n(17), i = n(69), o = n(70), s = n(73), a = n(74), f = n(21), c = n(22), l = n(78), h = n(24),
            u = n(10), g = n(0), p = n(80), d = n(25), v = n(84);
        t.exports = function (t, e, n, _, b, y, m) {
            var x = t[n], L = e[n], E = m.get(L);
            if (E) r(t, n, E); else {
                var S = y ? y(x, L, n + "", t, e, m) : void 0, w = void 0 === S;
                if (w) {
                    var M = c(L), j = !M && h(L), C = !M && !j && d(L);
                    S = L, M || j || C ? c(x) ? S = x : l(x) ? S = s(x) : j ? (w = !1, S = i(L, !0)) : C ? (w = !1, S = o(L, !0)) : S = [] : p(L) || f(L) ? (S = x, f(x) ? S = v(x) : (!g(x) || _ && u(x)) && (S = a(L))) : w = !1
                }
                w && (m.set(L, S), b(S, L, _, y, m), m.delete(L)), r(t, n, S)
            }
        }
    }, function (t, e, n) {
        (function (t) {
            var r = n(1), i = "object" == typeof e && e && !e.nodeType && e,
                o = i && "object" == typeof t && t && !t.nodeType && t, s = o && o.exports === i ? r.Buffer : void 0,
        ...
        var r = n(75), i = n(19), o = n(20);
        t.exports = function (t) {
            return "function" != typeof t.constructor || o(t) ? {} : r(i(t))
        }
    }, function (t, e, n) {
        var r = n(0), i = Object.create, o = function () {
            function t() {
            }
        ...
        var r = n(3), i = n(2), o = "[object Arguments]";
        t.exports = function (t) {
            return i(t) && r(t) == o
        }
    }, function (t, e, n) {
        ...
        var r = n(3), i = n(19), o = n(2), s = "[object Object]", a = Function.prototype, f = Object.prototype,
            c = a.toString, l = f.hasOwnProperty, h = c.call(Object);
        t.exports = function (t) {
            if (!o(t) || r(t) != s) return !1;
            var e = i(t);
            if (null === e) return !0;
        ...
        (function (t) {
            var r = n(16), i = "object" == typeof e && e && !e.nodeType && e,
        ...
        t.exports = function (t, e, n, o) {
            ...
            for (var a = -1, f = e.length; ++a < f;) {
                var c = e[a], l = o ? o(n[c], t[c], c, n, t) : void 0;
                void 0 === l && (l = t[c]), s ? i(n, c, l) : r(n, c, l)
            }
            return n
        }
    }, function (t, e, n) {
        var r = n(11), i = n(6), o = Object.prototype.hasOwnProperty;
        t.exports = function (t, e, n) {
            var s = t[e];
            o.call(t, e) && i(s, n) && (void 0 !== n || e in t) || r(t, e, n)
        }
    }, function (t, e, n) {
        var r = n(88), i = n(21), o = n(22), s = n(24), a = n(27), f = n(25), c = Object.prototype.hasOwnProperty;
        t.exports = function (t, e) {
            var n = o(t), l = !n && i(t), h = !n && !l && s(t), u = !n && !l && !h && f(t), g = n || l || h || u,
                p = g ? r(t.length, String) : [], d = p.length;
            for (var v in t) !e && !c.call(t, v) || g && ("length" == v || h && ("offset" == v || "parent" == v) || u && ("buffer" == v || "byteLength" == v || "byteOffset" == v) || a(v, d)) || p.push(v);
            return p
        }
    }, function (t, e) {
        t.exports = function (t, e) {
        ...
        var r = n(0), i = n(20), o = n(90), s = Object.prototype.hasOwnProperty;
        t.exports = function (t) {
            if (!r(t)) return o(t);
            var e = i(t), n = [];
        ...
        t.exports = function (t, e, n) {
            return e = i(void 0 === e ? t.length - 1 : e, 0), function () {
                for (var o = arguments, s = -1, a = i(o.length - e, 0), f = Array(a); ++s < a;) f[s] = o[e + s];
                s = -1;
        ...
        var r = n(97), i = n(18), o = n(28), s = i ? function (t, e) {
        ...
        var r = n(0), i = n(102), o = NaN, s = /^\s+|\s+$/g, a = /^[-+]0x[0-9a-f]+$/i, f = /^0b[01]+$/i,
        ...
        var r = n(3), i = n(2), o = "[object Symbol]";
        t.exports = function (t) {
            return "symbol" == typeof t || i(t) && r(t) == o
        }
    }, function (t, e, n) {
        var r = n(29), i = n(0), o = "Expected a function";
        t.exports = function (t, e, n) {
            var s = !0, a = !0;
        ...
        r.Diff, r.prototype.diff_main = function (t, e, n, r) {
            ...
            if (t == e) return t ? [[0, t]] : [];
            void 0 === n && (n = !0);
            var o = n, s = this.diff_commonPrefix(t, e), a = t.substring(0, s);
            ...
            if (!t) return [[1, e]];
            if (!e) return [[-1, t]];
            var o = t.length > e.length ? t : e, s = t.length > e.length ? e : t, a = o.indexOf(s);
            if (-1 != a) return i = [[1, o.substring(0, a)], [0, s], [1, o.substring(a + s.length)]], t.length > e.length && (i[0][0] = i[2][0] = -1), i;
            if (1 == s.length) return [[-1, t], [1, e]];
            var f = this.diff_halfMatch_(t, e);
            if (f) {
                var c = f[0], l = f[1], h = f[2], u = f[3], g = f[4], p = this.diff_main(c, h, n, r),
            ...
            var r = l.lineArray, i = this.diff_main(t, e, !1, n);
            ...
            for (var o = 0, s = 0, a = 0, f = "", c = ""; o < i.length;) {
                switch (i[o][0]) {
                    ...
                    case 0:
                        if (s >= 1 && a >= 1) {
                            i.splice(o - s - a, s + a), o = o - s - a;
                            for (var l, h = (l = this.diff_main(f, c, !1, n)).length - 1; h >= 0; h--) i.splice(o, 0, l[h]);
                            o += l.length
                        }
                        a = 0, s = 0, f = "", c = ""
                }
            ...
            for (var r = t.length, i = e.length, o = Math.ceil((r + i) / 2), s = o, a = 2 * o, f = new Array(a), c = new Array(a), l = 0; l < a; l++) f[l] = -1, c[l] = -1;
            f[s + 1] = 0, c[s + 1] = 0;
            for (var h = r - i, u = h % 2 != 0, g = 0, p = 0, d = 0, v = 0, _ = 0; _ < o && !((new Date).getTime() > n); _++) {
                for (var b = -_ + g; b <= _ - p; b += 2) {
                    for (var y = s + b, m = (w = b == -_ || b != _ && f[y - 1] < f[y + 1] ? f[y + 1] : f[y - 1] + 1) - b; w < r && m < i && t.charAt(w) == e.charAt(m);) w++, m++;
                    if (f[y] = w, w > r) p += 2; else if (m > i) g += 2; else if (u) {
                        if ((E = s + h - b) >= 0 && E < a && -1 != c[E]) if (w >= (L = r - c[E])) return this.diff_bisectSplit_(t, e, w, m, n)
                    }
                }
                for (var x = -_ + d; x <= _ - v; x += 2) {
                    for (var L, E = s + x, S = (L = x == -_ || x != _ && c[E - 1] < c[E + 1] ? c[E + 1] : c[E - 1] + 1) - x; L < r && S < i && t.charAt(r - L - 1) == e.charAt(i - S - 1);) L++, S++;
                    if (c[E] = L, L > r) v += 2; else if (S > i) d += 2; else if (!u) {
                        if ((y = s + h - x) >= 0 && y < a && -1 != f[y]) {
                            var w;
                            m = s + (w = f[y]) - y;
                            if (w >= (L = r - L)) return this.diff_bisectSplit_(t, e, w, m, n)
                        }
                    }
                }
            }
            ...
            var o = t.substring(0, n), s = e.substring(0, r), a = t.substring(n), f = e.substring(r),
                c = this.diff_main(o, s, !1, i), l = this.diff_main(a, f, !1, i);
            return c.concat(l)
            ...
            function i(t) {
                for (var e = "", i = 0, o = -1, s = n.length; o < t.length - 1;) {
                    ...
                    i = o + 1, (r.hasOwnProperty ? r.hasOwnProperty(a) : void 0 !== r[a]) ? e += String.fromCharCode(r[a]) : (e += String.fromCharCode(s), r[a] = s, n[s++] = a)
                }
                return e
            }
            ...
            if (t == e) return i;
            for (var o = 0, s = 1; ;) {
                var a = t.substring(i - s), f = e.indexOf(a);
                if (-1 == f) return o;
                s += f, 0 != f && t.substring(i - s) != e.substring(0, s) || (o = s, s++)
            }
            ...
            var s, a, f, c, l, h = o(n, r, Math.ceil(n.length / 4)), u = o(n, r, Math.ceil(n.length / 2));
            ...
            for (var e = !1, n = [], r = 0, i = null, o = 0, s = 0, a = 0, f = 0, c = 0; o < t.length;) 0 == t[o][0] ? (n[r++] = o, s = f, a = c, f = 0, c = 0, i = t[o][1]) : (1 == t[o][0] ? f += t[o][1].length : c += t[o][1].length, i && i.length <= Math.max(s, a) && i.length <= Math.max(f, c) && (t.splice(n[r - 1], 0, [-1, i]), t[n[r - 1] + 1][0] = 1, r--, o = --r > 0 ? n[r - 1] : -1, s = 0, a = 0, f = 0, c = 0, i = null, e = !0)), o++;
            for (e && this.diff_cleanupMerge(t), this.diff_cleanupSemanticLossless(t), o = 1; o < t.length;) {
                if (-1 == t[o - 1][0] && 1 == t[o][0]) {
                    var l = t[o - 1][1], h = t[o][1], u = this.diff_commonOverlap_(l, h),
                        g = this.diff_commonOverlap_(h, l);
                    u >= g ? (u >= l.length / 2 || u >= h.length / 2) && (t.splice(o, 0, [0, h.substring(0, u)]), t[o - 1][1] = l.substring(0, l.length - u), t[o + 1][1] = h.substring(u), o++) : (g >= l.length / 2 || g >= h.length / 2) && (t.splice(o, 0, [0, l.substring(0, g)]), t[o - 1][0] = 1, t[o - 1][1] = h.substring(0, h.length - g), t[o + 1][0] = -1, t[o + 1][1] = l.substring(g), o++), o++
                }
                o++
            }
            ...
            function e(t, e) {
                if (!t || !e) return 6;
                var n = t.charAt(t.length - 1), i = e.charAt(0), o = n.match(r.nonAlphaNumericRegex_),
                    s = i.match(r.nonAlphaNumericRegex_), a = o && n.match(r.whitespaceRegex_),
                    f = s && i.match(r.whitespaceRegex_), c = a && n.match(r.linebreakRegex_),
                    l = f && i.match(r.linebreakRegex_), h = c && t.match(r.blanklineEndRegex_),
            ...
            for (var n = 1; n < t.length - 1;) {
                if (0 == t[n - 1][0] && 0 == t[n + 1][0]) {
                    var i = t[n - 1][1], o = t[n][1], s = t[n + 1][1], a = this.diff_commonSuffix(i, o);
                    if (a) {
                        var f = o.substring(o.length - a);
                        i = i.substring(0, i.length - a), o = f + o.substring(0, o.length - a), s = f + s
                    }
            ...
            for (var e = !1, n = [], r = 0, i = null, o = 0, s = !1, a = !1, f = !1, c = !1; o < t.length;) 0 == t[o][0] ? (t[o][1].length < this.Diff_EditCost && (f || c) ? (n[r++] = o, s = f, a = c, i = t[o][1]) : (r = 0, i = null), f = c = !1) : (-1 == t[o][0] ? c = !0 : f = !0, i && (s && a && f && c || i.length < this.Diff_EditCost / 2 && s + a + f + c == 3) && (t.splice(n[r - 1], 0, [-1, i]), t[n[r - 1] + 1][0] = 1, r--, i = null, s && a ? (f = c = !0, r = 0) : (o = --r > 0 ? n[r - 1] : -1, f = c = !1), e = !0)), o++;
            e && this.diff_cleanupMerge(t)
        }, r.prototype.diff_cleanupMerge = function (t) {
            t.push([0, ""]);
            for (var e, n = 0, r = 0, i = 0, o = "", s = ""; n < t.length;) switch (t[n][0]) {
                case 1:
                    i++, s += t[n][1], n++;
                    break;
                case-1:
                    ...
                    break;
                case 0:
                    r + i > 1 ? (0 !== r && 0 !== i && (0 !== (e = this.diff_commonPrefix(s, o)) && (n - r - i > 0 && 0 == t[n - r - i - 1][0] ? t[n - r - i - 1][1] += s.substring(0, e) : (t.splice(0, 0, [0, s.substring(0, e)]), n++), s = s.substring(e), o = o.substring(e)), 0 !== (e = this.diff_commonSuffix(s, o)) && (t[n][1] = s.substring(s.length - e) + t[n][1], s = s.substring(0, s.length - e), o = o.substring(0, o.length - e))), 0 === r ? t.splice(n - i, r + i, [1, s]) : 0 === i ? t.splice(n - r, r + i, [-1, o]) : t.splice(n - r - i, r + i, [-1, o], [1, s]), n = n - r - i + (r ? 1 : 0) + (i ? 1 : 0) + 1) : 0 !== n && 0 == t[n - 1][0] ? (t[n - 1][1] += t[n][1], t.splice(n, 1)) : n++, i = 0, r = 0, o = "", s = ""
            }
            "" === t[t.length - 1][1] && t.pop();
            var a = !1;
            for (n = 1; n < t.length - 1;) 0 == t[n - 1][0] && 0 == t[n + 1][0] && (t[n][1].substring(t[n][1].length - t[n - 1][1].length) == t[n - 1][1] ? (t[n][1] = t[n - 1][1] + t[n][1].substring(0, t[n][1].length - t[n - 1][1].length), t[n + 1][1] = t[n - 1][1] + t[n + 1][1], t.splice(n - 1, 1), a = !0) : t[n][1].substring(0, t[n + 1][1].length) == t[n + 1][1] && (t[n - 1][1] += t[n + 1][1], t[n][1] = t[n][1].substring(t[n + 1][1].length) + t[n + 1][1], t.splice(n + 1, 1), a = !0)), n++;
            a && this.diff_cleanupMerge(t)
        }, r.prototype.diff_xIndex = function (t, e) {
            var n, r = 0, i = 0, o = 0, s = 0;
            for (n = 0; n < t.length && (1 !== t[n][0] && (r += t[n][1].length), -1 !== t[n][0] && (i += t[n][1].length), !(r > e)); n++) o = r, s = i;
            ...
            for (var n = [], r = 0, i = 0, o = e.split(/\t/g), s = 0; s < o.length; s++) {
                ...
                switch (o[s].charAt(0)) {
                    ...
                    case"=":
                        var f = parseInt(a, 10);
                        if (isNaN(f) || f < 0) throw new Error("Invalid number in diff_fromDelta: " + a);
                        var c = t.substring(i, i += f);
                        "=" == o[s].charAt(0) ? n[r++] = [0, c] : n[r++] = [-1, c];
                        break;
                    default:
                        if (o[s]) throw new Error("Invalid diff operation in diff_fromDelta: " + o[s])
                }
            }
            ...
            var r = this.match_alphabet_(e), i = this;

            function o(t, r) {
                var o = t / e.length, s = Math.abs(n - r);
                return i.Match_Distance ? o + s / i.Match_Distance : s ? 1 : o
            }

            var s = this.Match_Threshold, a = t.indexOf(e, n);
            -1 != a && (s = Math.min(o(0, a), s), -1 != (a = t.lastIndexOf(e, n + e.length)) && (s = Math.min(o(0, a), s)));
            var f, c, l = 1 << e.length - 1;
            a = -1;
            for (var h, u = e.length + t.length, g = 0; g < e.length; g++) {
                for (f = 0, c = u; f < c;) o(g, n + c) <= s ? f = c : u = c, c = Math.floor((u - f) / 2 + f);
                u = c;
                var p = Math.max(1, n - c + 1), d = Math.min(n + c, t.length) + e.length, v = Array(d + 2);
                v[d + 1] = (1 << g) - 1;
                for (var _ = d; _ >= p; _--) {
            ...
            var i, o;
            if ("string" == typeof t && "string" == typeof e && void 0 === n) i = t, (o = this.diff_main(i, e, !0)).length > 2 && (this.diff_cleanupSemantic(o), this.diff_cleanupEfficiency(o)); else if (t && "object" == typeof t && void 0 === e && void 0 === n) o = t, i = this.diff_text1(o); else if ("string" == typeof t && e && "object" == typeof e && void 0 === n) i = t, o = e; else {
            ...
            for (var s = [], a = new r.patch_obj, f = 0, c = 0, l = 0, h = i, u = i, g = 0; g < o.length; g++) {
                ...
                switch (f || 0 === p || (a.start1 = c, a.start2 = l), p) {
                    case 1:
                        a.diffs[f++] = o[g], a.length2 += d.length, u = u.substring(0, l) + d + u.substring(l);
                        break;
                    case-1:
                        a.length1 += d.length, a.diffs[f++] = o[g], u = u.substring(0, l) + u.substring(l + d.length);
                        break;
                    case 0:
            ...
            for (var r = 0, i = [], o = 0; o < t.length; o++) {
                var s, a, f = t[o].start2 + r, c = this.diff_text1(t[o].diffs), l = -1;
                if (c.length > this.Match_MaxBits ? -1 != (s = this.match_main(e, c.substring(0, this.Match_MaxBits), f)) && (-1 == (l = this.match_main(e, c.substring(c.length - this.Match_MaxBits), f + c.length - this.Match_MaxBits)) || s >= l) && (s = -1) : s = this.match_main(e, c, f), -1 == s) i[o] = !1, r -= t[o].length2 - t[o].length1; else if (i[o] = !0, r = s - f, c == (a = -1 == l ? e.substring(s, s + c.length) : e.substring(s, l + this.Match_MaxBits))) e = e.substring(0, s) + this.diff_text2(t[o].diffs) + e.substring(s + c.length); else {
                    var h = this.diff_main(c, a, !1);
                    if (c.length > this.Match_MaxBits && this.diff_levenshtein(h) / c.length > this.Patch_DeleteThreshold) i[o] = !1; else {
                        this.diff_cleanupSemanticLossless(h);
                        for (var u, g = 0, p = 0; p < t[o].diffs.length; p++) {
                            var d = t[o].diffs[p];
                            0 !== d[0] && (u = this.diff_xIndex(h, g)), 1 === d[0] ? e = e.substring(0, s + u) + d[1] + e.substring(s + u) : -1 === d[0] && (e = e.substring(0, s + u) + e.substring(s + this.diff_xIndex(h, g + d[1].length))), -1 !== d[0] && (g += d[1].length)
                        }
                    }
                }
            }
            ...
            var i = t[0], o = i.diffs;
            if (0 == o.length || 0 != o[0][0]) o.unshift([0, n]), i.start1 -= e, i.start2 -= e, i.length1 += e, i.length2 += e; else if (e > o[0][1].length) {
                var s = e - o[0][1].length;
                o[0][1] = n.substring(o[0][1].length) + o[0][1], i.start1 -= s, i.start2 -= s, i.length1 += s, i.length2 += s
            }
            if (0 == (o = (i = t[t.length - 1]).diffs).length || 0 != o[o.length - 1][0]) o.push([0, n]), i.length1 += e, i.length2 += e; else if (e > o[o.length - 1][1].length) {
                s = e - o[o.length - 1][1].length;
                o[o.length - 1][1] += n.substring(0, s), i.length1 += s, i.length2 += s
            }
            return n
            ...
            for (var e = this.Match_MaxBits, n = 0; n < t.length; n++) if (!(t[n].length1 <= e)) {
                ...
                for (var o = i.start1, s = i.start2, a = ""; 0 !== i.diffs.length;) {
                    ...
                    for (f.start1 = o - a.length, f.start2 = s - a.length, "" !== a && (f.length1 = f.length2 = a.length, f.diffs.push([0, a])); 0 !== i.diffs.length && f.length1 < e - this.Patch_Margin;) {
                        var l = i.diffs[0][0], h = i.diffs[0][1];
                    ...
                    "" !== u && (f.length1 += u.length, f.length2 += u.length, 0 !== f.diffs.length && 0 === f.diffs[f.diffs.length - 1][0] ? f.diffs[f.diffs.length - 1][1] += u : f.diffs.push([0, u])), c || t.splice(++n, 0, f)
                }
            }
            ...
            for (var n = t.split("\n"), i = 0, o = /^@@ -(\d+),?(\d*) \+(\d+),?(\d*) @@$/; i < n.length;) {
                ...
                for (e.push(a), a.start1 = parseInt(s[1], 10), "" === s[2] ? (a.start1--, a.length1 = 1) : "0" == s[2] ? a.length1 = 0 : (a.start1--, a.length1 = parseInt(s[2], 10)), a.start2 = parseInt(s[3], 10), "" === s[4] ? (a.start2--, a.length2 = 1) : "0" == s[4] ? a.length2 = 0 : (a.start2--, a.length2 = parseInt(s[4], 10)), i++; i < n.length;) {
                    ...
                    if ("-" == f) a.diffs.push([-1, c]); else if ("+" == f) a.diffs.push([1, c]); else if (" " == f) a.diffs.push([0, c]); else {
                        if ("@" == f) break;
                        if ("" !== f) throw new Error('Invalid patch mode "' + f + '" in: ' + c)
                    }
                    i++
                }
            }
            ...
            return e.join("").replace(/%20/g, " ")
        }, t.exports = r, t.exports.diff_match_patch = r, t.exports.DIFF_DELETE = -1, t.exports.DIFF_INSERT = 1, t.exports.DIFF_EQUAL = 0
    }, function (t, e, n) {
        "use strict";
        ...
        Object.defineProperty(e, "__esModule", {value: !0}), e.default = function (t, e) {
            var n = Math.random().toString(36).substr(2, 5), r = "js-" + e + "-" + n, i = t.querySelector("." + e);
            if (i) return i.id = i.id || r, i.id;
        ...
        Object.defineProperty(e, "__esModule", {value: !0}), e.default = {
            on: function (t, e, n, r) {
                ...
                i.addEventListener(e, function (t) {
                    for (var e = i.querySelectorAll(n), o = t.target, s = 0, a = e.length; s < a; s += 1) for (var f = o, c = e[s]; f && f !== i;) f === c && r.call(c, t), f = f.parentNode
                })
            }
        }
    }]).default
